...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /catkin_ws_d435i/src/realsense-ros/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /catkin_ws_d435i/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /catkin_ws_d435i/install)
...
if(NOT "/catkin_ws_d435i/devel/include " STREQUAL " ")
  set(realsense2_camera_INCLUDE_DIRS "")
  set(_include_dirs "/catkin_ws_d435i/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws_d435i/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /catkin_ws_d435i/devel/lib;/root/catkin_ws_d435i/devel/lib;/opt/ros/melodic/lib)
