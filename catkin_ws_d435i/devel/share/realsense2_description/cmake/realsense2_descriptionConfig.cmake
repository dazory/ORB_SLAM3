...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /catkin_ws_d435i/src/realsense-ros/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /catkin_ws_d435i/devel)
  ...
  set(realsense2_description_INSTALL_PREFIX /catkin_ws_d435i/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws_d435i/src/realsense-ros/realsense2_description/${idir}'.  ${_report}")
    endif()
